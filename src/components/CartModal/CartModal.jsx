...
function CartModal() {
    const { choosenProducts } = useContext(appContext)
    return (
        <div className={`absolute opacity-1 rounded-2xl top-[130%] right-0 m-auto mr-4 shadow-zinc-700 shadow-2xl bg-slate-100 w-[90vw] ${window.innerWidth > "375" ? "w-[40vw]" : ""}`}>
